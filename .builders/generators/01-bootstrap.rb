KManager.action :bootstrap do
  action do
    application_name = :printspeak_rails_upgrade
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Rails Upgrader',
        ...
        application_lib_namespace:  'PrintspeakRailsUpgrade',
        namespaces:                 ['PrintspeakRailsUpgrade'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a developer, I want upgrade my Rails 6.0 to 6.1, 7.0 and 7.1, so that I can get all apps upgraded as once',
        copyright_date:             '2023',
        website:                    'http://appydave.com/gems/printspeak_rails_upgrade'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'printspeak_rails_upgrade'
